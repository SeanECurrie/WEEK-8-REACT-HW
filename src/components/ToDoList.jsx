    ...
    render() {
        return (  
            ...
            <Input sx={{m:2}}
              ...
              />
              <br/>
              <Button sx={{m:2}}variant="contained" onClick={() => this.addItem()}>
              Add
              </Button>
              <br/>
              <List sx={{border: 2, gap: 2, mx : 'auto', width: '80%', bgcolor: 'background.paper'}}>
                {this.state.list.map(item => {
                  return(
                    <ListItem key={item.id} secondaryAction={<IconButton 
              ...
              <Box sx={{m:2,borderRadius: 4, border:2, width: '75%', mx: 'auto'}}>
                <Typography variant="subtitle2">check off items when finished!</Typography>
                </Box>
          </div>  
